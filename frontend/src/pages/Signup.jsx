...
function Signup(){
    ...
    return(
        <div className="min-h-screen flex items-center justify-center p-6">
            <div className="max-w-md w-full bg-white p-6 roubded shadow">
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                    ...
                    <input name="password2" type="password" onChange={handleChange} value={form.password2} placeholder="Password" required className="w-full p-2 border rounded"/>
